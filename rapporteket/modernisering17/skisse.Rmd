...
prosjektbeskrivelse som forelegges et eget forvaltnigsorgan for Rapporteket
ved HNIKT. Dette forvaltningsorganet beslutter om prosjketet skal settes
...
driftsleverandør av Rapporteket. Dette er særlig aktulet når ansvar for drift
...
Forlag til endringe går overordnet ut på at dagens BI-løsning basert på
...
### Teknologi
Mye av den underliggende teknologien vil bli beholdt slik den er idag. Endringe
...
presentasjon i tillegg til brukerhåndtering (autentisering og autorisajon)
...
_Shiny Server_, TEST og PRODUKSJON. Innledingsvis vil det være tilstrekkelig
...
_Shiny Server_ hvoretter noe (eller all?) funskjonalitet opphører å fungere
...
prosjektet trenger lengre tid så må det (om mulig) i så fall avtales spesietlt
med RStudio.
...
anslått. Det vil sikkert være behov for å kopletterer og detaljere denne lista.
...
lista over aktiviet er mer komplett, kvalitetssikret og detljert. Timeprisen
